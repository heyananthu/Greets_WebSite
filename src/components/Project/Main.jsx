...
function Main() {
    return (
        <div className="min-h-screen w-full flex items-center justify-center p-6 mt-28">
            <div className="w-full max-w-screen px-5 grid grid-cols-1 md:grid-cols-[1.4fr_2fr] gap-6 rounded-[2rem]">
                {/* Left column */}
                <div className="flex flex-col gap-6 w-full font-fahkwang">
                    {/* Top card */}
                    <div className="bg-[#ffe48c] rounded-[1.3rem] flex flex-col items-center justify-center p-10 h-[320px] md:h-[380px] w-full">
                        <h2 className="text-4xl md:text-5xl font-bold mb-4 text-center">Our Projects</h2>
                ...
                <div className="w-full">
                    <img
                        ...
                        className="rounded-[2rem] object-cover w-full h-[700px] md:h-[900px]"
                    />
                </div>
            </div>
        </div>
