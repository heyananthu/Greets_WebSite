        ...
        <div className='bg-black text-white font-questrial min-h-screen py-8 px-4'>
            <div className="max-w-screen mx-auto px-12 pt-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 ">
                    ...
                    <div
                        className="bg-white lg:-translate-x-[4.5rem] text-black rounded-[3rem] p-8 flex flex-col justify-end min-h-[290px] w-full md:w-[29rem] shadow-md"
                    >
                    ...
                    <div
                        className="bg-white lg:-translate-x-[4.5rem] text-black rounded-[3rem] rounded-br-none p-8 flex flex-col justify-end min-h-[290px] w-full md:w-[29rem] shadow-md"
                    >
