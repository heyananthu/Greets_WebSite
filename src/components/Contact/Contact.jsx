    ...
    return (
        <div className="min-h-screen  flex items-center px-6 py-10 mt-28 font-questrial">
            <div className="w-full max-w-screen flex flex-col lg:flex-row gap-8">
                {/* Left: Contact Form */}
                <div className="bg-gray-300 rounded-[2rem] rounded-tl-none rounded-bl-none p-8 lg:p-5 flex flex-col h-fit md:h-screen w-full lg:w-[55%] overflow-y-auto">
                    ...
                    <form className="relative flex flex-col gap-4 lg:w-[70%] lg:space-y-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" placeholder='First name' className="w-full h-[2.75rem] px-4 py-2 bg-white text-black " />
                            </div>
                            <div>
                                {/* <label className="text-gray-400 text-sm mb-1 block">Last name</label> */}
                                <input type="text" placeholder='Last name' className="w-full h-[2.75rem] px-4 py-2 bg-white text-black " />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="email" placeholder='Email' className="w-full h-[2.75rem] px-4 py-2 bg-white text-black " />
                            </div>
                            <div>
                                ...
                                <div className="relative">
                                    <PhoneInput
                                        ...
                                        inputClass="!w-full !h-[2.85rem] !py-2 !pl-16 !pr-4 !text-black !bg-white !border !border-gray-300 focus:!outline-none focus:!ring-1 focus:!ring-black !leading-normal"
