...
function Mep4() {
    return (
        <div className="min-h-[750px] w-screen bg-black flex flex-col items-center py-8 font-questrial">
            ...
            <div className="w-full max-w-7xl flex flex-col items-center">
                <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-6 px-4 md:px-0 mb-12">
