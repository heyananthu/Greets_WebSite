...
function EcologicalTransformationCard() {
    ...
    return (
        <div className="h-[75vh] md:h-[95vh] w-full flex items-center justify-center font-questrial px-2 sm:px-4 py-4 sm:py-0 relative">
            <div className="w-[96vw] sm:w-[92vw] max-w-screen h-full bg-stone-300 rounded-[24px] sm:rounded-[48px] rounded-br-none rounded-bl-none flex flex-col overflow-hidden">
                {/* Content */}
