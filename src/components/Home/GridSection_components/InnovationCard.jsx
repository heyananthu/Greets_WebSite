...
function InnovationCard() {
    ...
    return (
        <div className="h-screen w-full flex items-center justify-center font-questrial px-4 relative">
            ...
            <div className="w-[92vw] max-w-screen h-full bg-stone-200 rounded-[48px] rounded-br-none rounded-bl-none flex flex-col md:flex-row overflow-hidden">
                {/* Left Side - Content */}
                <div className="md:flex-1 flex flex-col justify-center py-2 md:py-5 px-6 md:mb-12 lg:mb-0">
                    ...
                    <div className="mt-8">
                        <button 
                            ...
                            className="px-6 py-3 cursor-pointer border border-green-700 rounded-bl-none rounded-[2rem] text-sm bg-green-700 text-white hover:bg-white hover:text-green-700 transition-all duration-200 hover:scale-105"
                        >
                            Check Our Services
                        </button>
                    </div>
