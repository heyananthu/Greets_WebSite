        ...
        >
            ...
            <div className="relative z-10 flex  h-full px-6 sm:px-10 md:px-20 lg:pl-36 pt-20 ">
                <div className="text-white space-y-6 md:space-y-20 font-questrial max-w-6xl text-left">
                    ...
                    <button className="mt-6 sm:mt-8 px-8 sm:px-10 py-2 sm:py-3 border border-white bg-transparent rounded-bl-none rounded-[5rem] text-white text-sm hover:bg-green-600 hover:bg-opacity-20 transition-all duration-200">
                        Read More
                    </button>
                </div>
            </div>
