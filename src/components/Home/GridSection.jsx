            ...
            <div className='font-[var(--font-questrial)]'>
                ...
                <div className="flex flex-col md:flex-row md:justify-between md:gap-4 lg:gap-4 mb-6 w-full mx-auto space-y-4">
                    ...
                    <div className="w-full md:flex-1 min-w-0 lg:ml-16">
                        <div className="bg-green-700 text-white p-6 md:p-8 rounded-tr-[2.5rem] shadow h-fit md:h-[21.5rem] lg-h-[21rem] flex flex-col justify-between">

                            <div className='lg:px-6 lg:py-6'>
                                <h2 className="text-2xl lg:text-4xl font-bold mb-4">Complete MEP Solutions, Tailored for Every Sector </h2>
                                <p className="text-sm md:text-base">
                                    GREETS provides end-to-end MEP services—spanning design, planning, estimation, procurement, and execution—crafted to meet the unique needs of Residential, Commercial, Industrial, Healthcare, Hospitality, Educational, and Government projects.</p>                             </div>
                            <div className='lg:px-6 mt-3 md:mt-2 lg:mt-0'>
                    ...
                    <div className="w-full md:flex-1 min-w-0">
                        <div className="bg-stone-300 p-6 md:p-8 rounded-tl-[2.5rem] shadow flex flex-col justify-between md:h-[21.5rem] lg:h-[21rem] h-auto">
                            <div className='px-0 md:px-2 lg:px-6 py-2 lg:py-4'>
                                <h2 className="text-2xl lg:text-4xl font-bold text-green-700 mb-2 ">Driving Ecological Transformation</h2>
                                <p className="text-green-700 text-sm md:text-base w-full lg:w-[80%]">
                                We are committed to delivering sustainable, cost-effective, and impactful MEP systems that support LEED and other green building certifications—ensuring every project contributes positively to the environment and community.                                </p>
                            </div>
                            <div className='px-0  lg:px-6 lg:mt-4 '>
                ...
                <div className="flex flex-col md:flex-row md:justify-start gap-6 w-full md:px-2 lg:px-0">
                    ...
                    {/* Relaunch Block */}
                    <div className="bg-stone-200 p-6 md:p-10 rounded-[2.5rem] shadow h-auto   lg:h-[20rem] w-full md:w-[35rem] lg:w-[46rem] flex flex-col ">
                        <div className='lg:px-6'>
                            <h2 className="text-2xl md:text-3xl font-bold mb-4">Passion-Driven MEP Innovation </h2>
                            <p className="text-green-700 text-sm md:text-base mb-4 lg:w-[78%]">
                                Our team thrives on delivering results that balance ecology, economy, and efficiency. Headquartered in India, with a presence in the Maldives, Mauritius, Seychelles, Gambia, and other tropical regions, we manage complex international projects with precision and care.                                </p>
                        </div>
                        <div className='lg:px-6'>
